...
# Define wealthy countries to filter by (using country codes)
wealthy_countries = [
    'US', 'CA', 'GB', 'AU',  # USA, Canada, UK, Australia
    'DE', 'FR', 'NL', 'CH', 'SE',  # Germany, France, Netherlands, Switzerland, Sweden
    'NO', 'DK', 'FI', 'IE', 'BE',  # Norway, Denmark, Finland, Ireland, Belgium
    'NZ', 'AT', 'SG'  # New Zealand, Austria, Singapore
]
